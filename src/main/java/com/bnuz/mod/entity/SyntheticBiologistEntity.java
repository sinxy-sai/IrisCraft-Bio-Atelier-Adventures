...
public class SyntheticBiologistEntity extends MerchantEntity implements NamedScreenHandlerFactory {

    private boolean recipesFilled = false;   // 只做一次

    public SyntheticBiologistEntity(EntityType<? extends MerchantEntity> entityType, World world) {
    ...
    protected void fillRecipes() {
        ...
        this.getOffers().add(new TradeOffer(
                ...
                new ItemStack(ModItems.HYDROGEL, 1),
                12, 3, 0.075f
        ));
    }
    ...
    public Text getDisplayName() {
        return Text.translatable("entity.bnuz-mod.synthetic_biologist");
    }
